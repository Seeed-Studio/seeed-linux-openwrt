...
(function () {
    ...
    function getDisplayData(data, totals) {
        var result =
            ...
            createTH('Download Bandwidth', {id: 'thDownload'}) +
            createTH('Upload Bandwidth', {id: 'thUpload'}) +
            createTH('Total Download Traffic', {id: 'thTotalDown'}) +
            createTH('Total Upload Traffic', {id: 'thTotalUp'}) +
            createTH('Total Traffic', {id: 'thTotal'}) +
            ...
            if (this.readyState == 4 && this.status == 200) {
                ...
                if (!match) {
                    ...
                    if (!v) {
                        ...
                        // set old date
                        oldDate = new Date();
                        document.getElementById('updated').innerHTML = 'data updated on ' + dateToString(oldDate);
                    }
                }
    ...
    function updateSeconds(start) {
        setUpdateMessage('after <b><font color="blue">' + start + '</font></b> to refresh.');
        if (start > 0) {
